...
5.  *(Espacio de 10pt)* **PROYECTO** (12pt, Negrita)
6.  *(Espacio de 10pt)* **Logo UNIFRANZ** (Centrado, Ancho: 7.04 cm, Alto: 6.68 cm)
...
7.  *(Espacio de 35pt)* **"TITULO DEL PROYECTO"** (13pt, Negrita)
8.  *(Espacio de 35pt)* Subtítulo/Descripción (12pt, Normal)
9.  *(Espacio de 45pt)* **AUTOR: (Nombre)** (12pt)
10. **TUTOR: (Nombre)** (12pt)
11. *(Espacio de 45pt)* **EL ALTO - BOLIVIA \n 2026** (12pt, Negrita)
